...
int main() {
    ...
    // Get dimensions
    std::cout << std::endl << testMat1.numRows() << " x " << testMat1.numCols() << std::endl;
    
    // Get value at position
    std::cout << std::endl << "Value at pos 0x0: " << testMat1.getVal(0, 0) << std::endl;
    
    // Set value at position
    testMat1.setVal(0, 0, 5);
    std::cout << std::endl << "Value now at pos 0x0: " << testMat1.getVal(0, 0) << std::endl;
    ...
    std::cout << std::endl << "Determinant: " << testMat2.determinant() << std::endl;
